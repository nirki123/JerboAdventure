...
class Gun extends Base_object {
  ...
  public void hit(Hero hero) {
    for(int counter = 0; counter < ammo_max; counter++){
      bullet.x = ammo[counter].x;
      bullet.y = ammo[counter].y;
      if(colider.point_intersection(bullet, hero) && hero.lifePoint > 0){
        if(!ammo[counter].hit){
...
class Colider{
  ...
  private boolean point_intersection(Point point, King king){
    float cos = cos(radians(king.direction)); //cosinus to find the vertexes.
    float sin = sin(radians(king.direction)); //sinus to find the vertexes.
    int adjacent = int(cos * king.object_width/2); //the adjacent of the triangle to find the vertexes.
    int opposite = int(sin * king.object_width/2); //the opposite of the triangle to find the vertexes.
    float cos_2 = cos(radians(90 - king.direction)); //cosinus to find the vertexes. to move the point from the center of the leg to the vertex.
    float sin_2 = sin(radians(90 - king.direction)); //sinus to find the vertexes. to move the point from the center of the leg to the vertex.
    int adjacent_2 = int(cos_2 * king.object_height/2); //the adjacent of the triangle to find the vertexes. to move the point from the center of the leg to the vertex.
    int opposite_2 = int(sin_2 * king.object_height/2); //the opposite of the triangle to find the vertexes. to move the point from the center of the leg to the vertex.
    ...
    float wanted_direction_degrees; //the angle between the mouse and vertex on degrees.
    int mouse_vertex_direction; //the final angle between the mouse and vertex on degrees.
    int calculations_direction = king.direction; //new variable to save the value of the direction so we wouldn't change the direction of the rect.
    ...
    vertex_1_x = king.x - adjacent - adjacent_2;
    vertex_1_y = king.y - opposite + opposite_2;
    ...
    float wanted_direction_degrees_2;
    int mouse_vertex_2_direction;
    int calculations_direction_2 = king.direction;
    int calculations_direction_2_2;
    y_distance_from_vertex_2 = point.y - vertex_2_y;
    x_distance_from_vertex_2 = point.x - vertex_2_x;
    tangent_2 = y_distance_from_vertex_2/x_distance_from_vertex_2;
    ...
    vertex_2_x = king.x + adjacent + adjacent_2;
    vertex_2_y = king.y + opposite - opposite_2;
    
    calculations_direction_2 = king.direction + 90;
    calculations_direction_2_2 = king.direction + 180;
  ...
  private boolean point_intersection(Point point, Hero hero){
    float cos = cos(radians(hero.direction)); //cosinus to find the vertexes.
    float sin = sin(radians(hero.direction)); //sinus to find the vertexes.
    int adjacent = int(cos * hero.object_width/2); //the adjacent of the triangle to find the vertexes.
    int opposite = int(sin * hero.object_width/2); //the opposite of the triangle to find the vertexes.
    float cos_2 = cos(radians(90 - hero.direction)); //cosinus to find the vertexes. to move the point from the center of the leg to the vertex.
    float sin_2 = sin(radians(90 - hero.direction)); //sinus to find the vertexes. to move the point from the center of the leg to the vertex.
    int adjacent_2 = int(cos_2 * hero.object_height/2); //the adjacent of the triangle to find the vertexes. to move the point from the center of the leg to the vertex.
    int opposite_2 = int(sin_2 * hero.object_height/2); //the opposite of the triangle to find the vertexes. to move the point from the center of the leg to the vertex.
    ...
    float wanted_direction_degrees; //the angle between the mouse and vertex on degrees.
    int mouse_vertex_direction; //the final angle between the mouse and vertex on degrees.
    int calculations_direction = hero.direction; //new variable to save the value of the direction so we wouldn't change the direction of the rect.
    ...
    vertex_1_x = hero.x - adjacent - adjacent_2;
    vertex_1_y = hero.y - opposite + opposite_2;
    ...
    float wanted_direction_degrees_2;
    int mouse_vertex_2_direction;
    int calculations_direction_2 = hero.direction;
    int calculations_direction_2_2;
    y_distance_from_vertex_2 = point.y - vertex_2_y;
    x_distance_from_vertex_2 = point.x - vertex_2_x;
    tangent_2 = y_distance_from_vertex_2/x_distance_from_vertex_2;
    ...
    vertex_2_x = hero.x + adjacent + adjacent_2;
    vertex_2_y = hero.y + opposite - opposite_2;
    
    calculations_direction_2 = hero.direction + 90;
    calculations_direction_2_2 = hero.direction + 180;
